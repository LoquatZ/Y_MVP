package com.yuang.library.widget.pop_window.window;
...
import com.yuang.library.widget.pop_window.view.PopDownView;
...
//            showAsDropDown(view, 0, 0);
            //兼容7.0顶部弹窗
            showDropDown(PopDownWindow.this,view,0,0);
        }
    }

    private void showDropDown(PopupWindow pw,  View anchor,  int xoff,  int yoff) {
