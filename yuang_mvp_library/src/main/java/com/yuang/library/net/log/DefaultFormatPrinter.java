 ...
 */
package com.yuang.library.net.log;

import android.text.TextUtils;

import com.yuang.library.net.YHttpLoggingInterceptor;
import com.yuang.library.utils.LogUtils;
...
public class DefaultFormatPrinter implements FormatPrinter {
    private static final String TAG = "YuangHttpLog";
    ...
    public void printJsonResponse(long chainMs, boolean isSuccessful, int code, String headers, MediaType contentType,
        ...
        bodyString = YHttpLoggingInterceptor.isJson(contentType) ? CharacterHandler.jsonFormat(bodyString)
                : YHttpLoggingInterceptor.isXml(contentType) ? CharacterHandler.xmlFormat(bodyString) : bodyString;
