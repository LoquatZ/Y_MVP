package com.yuang.library.utils.rx_utils;
...
public class RxDataUtils {
     ...
     * @return
     */
    public static boolean isPassWordNO(String pass) {

        if (!TextUtils.isEmpty(pass)) {
            Pattern p = Pattern.compile("^[0-9a-zA-Z._+=!*]{6,18}$");
     ...
     * @return
     */
    public static boolean isSMSCodeNO(String pass) {
