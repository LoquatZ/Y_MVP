...
import com.yuang.banner.adapter.MZHolderCreator;
import com.yuang.banner.adapter.MZViewHolder;
import com.yuang.banner.loader.ImageLoaderInterface;
import com.yuang.banner.transformer.CoverModeTransformer;
import com.yuang.banner.view.CustomViewPager;
...
public class MZBannerView<T> extends RelativeLayout {
    ...
    private int[] mIndicatorRes = new int[]{R.drawable.gray_radius, R.drawable.white_radius};
    ...
    private void init() {
        View view = LayoutInflater.from(getContext()).inflate(R.layout.mz_banner_effect_layout, this, true);
    ...
    private void initIndicator() {
        ...
        for (int i = 0; i < mDatas.size(); i++) {
            ...
            if (mIndicatorAlign == IndicatorAlign.LEFT.ordinal()) {
                if (i == 0) {
                    int paddingLeft = mIndicatorPaddingLeft + mMZModePadding;
                ...
                if (i == mDatas.size() - 1) {
                    int paddingRight = mMZModePadding + mIndicatorPaddingRight;
     ...
     */
    public void setPages(List<T> datas) {
        if (datas == null) {
            return;
        }
        mDatas = datas;
        ...
        mAdapter = new MZPagerAdapter(datas, mIsCanLoop);
    ...
    public MZBannerView<T> setImageLoader(ImageLoaderInterface imageLoader) {
    ...
    public class MZPagerAdapter<T> extends PagerAdapter {
        private List<T> mDatas;
        private MZHolderCreator mMZHolderCreator = new MZHolderCreator() {
            @Override
        ...
        public MZPagerAdapter(List<T> datas, boolean canLoop) {
            if (mDatas == null) {
    ...
    public class BannerViewHolder implements MZViewHolder<String> {
        ...
        public void onBind(Context context, int position, String data) {
            // 数据绑定
            imageLoader.displayImage(context, data, mImageView);
        }
    }
